...
VERTICAL_SONAR_TOPIC = "/sonar_oculus_node/M1200d/ping"
GYRO_TOPIC = "/gyro"
...
BATHY_FEATURE_TOPIC = SLAM_NS + "bathy_extraction/bottom_scan"
BATHY_FEATURE_IMG_TOPIC = SLAM_NS + "bathy_extraction/feature_img"
